...
2. Double-click to open in your browser (Chrome, Edge, or Safari recommended)
3. Click the play buttons (▶) to hear pronunciations

### On Phone:
1. Download the files to your phone
2. Open with your Files app or browser
3. Tap play buttons to hear audio
...
The audio uses your browser's built-in Text-to-Speech (TTS) feature.

**Best Experience:**
- Chrome or Edge (Windows/Mac/Android)
- Safari (iPhone/Mac)
- Japanese language pack installed (for most accurate pronunciation)

**Note:** Audio may not work when viewing files directly from Google Drive preview. Download the files or use GitHub Pages instead.
...
- No tipping required
- Many places require payment at the register, not the table
- Use "お会計お願いします" (okaikei onegaishimasu) for the check
